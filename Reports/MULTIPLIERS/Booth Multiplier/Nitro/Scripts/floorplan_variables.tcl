...
set fp_units            micro
set fp_top_partition    "BAMIntegrated"         ; # INPUT REQUIRED: Top partition name
...
set pg_stripe_spacing	        4.0u       ; # Spacing between stripes
set pg_stripe_step              2.4u      ; # Step spacing for repeating patterns
set pg_stripe_offset_left       0.1u		; # Offset from left side of chip to start vertical stripe patterns
set pg_stripe_offset_right      0.1u		; # Offset from right side of chip to stop vertical stripe patterns
set pg_stripe_offset_top        0u		; # Offset from top of chip to stop horizontal stripe patterns
set pg_stripe_offset_bottom     0u		; # Offset from bottom of chip to start horizontal stripe patterns
