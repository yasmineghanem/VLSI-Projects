...
set workdir  "/home/vlsi/Desktop/Mini_Project_2/FloorPlan/Floorplaning_Booth_Multiplier" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_adder.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "BAMIntegrated"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
